...
const HeroSection = () => {
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center max-w-6xl mx-auto px-6">
        ...
        <div className="space-y-8">
          <p className="text-base md:text-lg lg:text-xl text-[#F4FBFE]/90 font-light max-w-4xl mx-auto leading-relaxed tracking-wide">
            ...
            is to create a seamless distribution process that connects and
            supports a thriving community of vaping enthusiasts and smokers
      ...
      <div
        className="absolute bottom-0 left-0 w-1/2 h-48 z-20"
      ...
      <div
        className="absolute bottom-0 right-0 w-1/2 h-48 z-20"
        style={{ pointerEvents: "none" }}
      >
        <svg
          viewBox="0 0 100 100"
