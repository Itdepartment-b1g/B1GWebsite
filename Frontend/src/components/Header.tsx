...
const Header = ({ alwaysShowBg = false }: HeaderProps) => {
  ...
  return (
    <>
      {/* 18+ Warning Header */}
      <div className="fixed top-0 left-0 right-0 z-50 bg-[#000204] backdrop-blur-md border-b border-[#FF9BFF]/20 shadow-lg">
        <div className="max-w-7xl mx-auto px-6 py-3">
          <div className="flex items-center justify-center">
            <div className="flex items-center space-x-4 text-center">
            <div className="flex items-center justify-center w-9 h-9 rounded-lg bg-[#FF9BFF]/15 backdrop-blur-sm flex-shrink-0">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-2 space-y-1 sm:space-y-0">
                <span className="text-[#F4FBFE] text-xs md:text-sm font-bold tracking-wider uppercase">
                  Government Warning:
                </span>
                <p className="text-[#F4FBFE] text-xs md:text-sm font-medium leading-relaxed max-w-5xl">
                  This product contains nicotine, a highly addictive substance. For adult use only. Not recommended for non-smokers.
                </p>
              </div>
            </div>
          </div>
      ...
      {/* Main Header - Adjusted for warning banner */}
      <header className={`fixed top-[60px] left-0 right-0 z-40 transition-all duration-500 ${
        showBg 
